...
public class WaitUtility {
	...
	public void waitUntilattributeToBeNotEmpty(WebDriver driver, WebElement element,String value) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(EXPLICITWAIT));
		wait.until(ExpectedConditions.attributeToBeNotEmpty(element,value));
}
	public void waitUntilElementSelectedStateToBeTrue(WebDriver driver, WebElement element) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(EXPLICITWAIT));
